...
<body>
  ...
  <section class="banner-sec">
    <img class="desk" src="images/Refrigerator-Repair.jpg" alt="" />
    <img class="mob" src="images/Refrigerator-Repair.jpg" alt="" />
    <div class="banner-content">
      <!-- <h2>PROVIDE QUALITY<br />REPAIR SERVICE</h2> -->
      <h2>Refrigerator Repair Services in Noida</h2>
    </div>
  </section>
  ...
  <section class="define">
    <div class="container">
      <div class="main_def">
        <div class="main-left">
          <div class="repair">
            <h2>Refrigerator Service Center in Greater Noida</h2>
          ...
          <div class="repair">
            <h3>Fridge Repair Services in Greater Noida</h3>
  ...
  <section class="reviews">
    <div class="container">
      <h2 class="head-comm">7 Types of Fridges for Every Space and Budget</h2>
      <div class="main-d">
        <div class="comm-d">
          <figure>
            <img src="images/services/fridge/1.jpg" alt="">
          </figure>
          <div class="low">
            <h2>The Built-In Refrigerator</h2>
        ...
        <div class="comm-d">
          <figure>
            <img src="images/services/fridge/2.jpg" alt="">
          </figure>
          <div class="low">
            <h2>The Top Freezer Refrigerator</h2>
        ...
        <div class="comm-d">
          <figure>
            <img src="images/services/fridge/3.jpg" alt="">
          </figure>
          <div class="low">
            <h2>The Bottom Freezer</h2>
        ...
        <div class="comm-d">
          <figure>
            <img src="images/services/fridge/4.jpg" alt="">
          </figure>
          <div class="low">
            <h2>The Side-by-Side Refrigerator</h2>
        ...
        <div class="comm-d">
          <figure>
            <img src="images/services/fridge/5.jpg" alt="">
          </figure>
          <div class="low">
            <h2>The French Door Refrigerator</h2>
        ...
        <div class="comm-d">
          <figure>
            <img src="images/services/fridge/6.jpg" alt="">
          </figure>
          <div class="low">
            <h2>Wine Cooler</h2>
        ...
        <div class="comm-d">
          <figure>
            <img src="images/services/fridge/7.jpg" alt="">
          </figure>
          <div class="low">
            <h2>The Classic Refrigerator</h2>
