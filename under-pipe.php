...
<body>
  ...
  <section class="banner-sec">
    <img class="desk" src="images/underground-piping.jpg" alt="" />
    <img class="mob" src="images/underground-piping-2.jpg" alt="" />
    <div class="banner-content">
      <!-- <h2>PROVIDE QUALITY<br />REPAIR SERVICE</h2> -->
      <h2>UNDERGROUND PIPELINE</h2>
  ...
  <!-- <section class="safe_side_main">
    <div class="container">
      ...
      <div class="safe_menu">
        <h2>Best-in-class safety measures</h2>
        <div class="work_on_progress ">
          <div class="work-progress">
            <div class="work-icon-box ">
              <span><img src="images/services/air/masks.png"></span>
            </div>
            <h3 class="caption">Usage of masks &amp; gloves</h3>
          </div>
          <div class="work-arrow">
          </div>
          <div class="work-progress">
            <div class="work-icon-box">
              <span><img src="images/services/air/tempreture.png"></span>
            </div>
            <h3 class="caption">Tempreture checks</h3>
          </div>
          <div class="work-arrow">
          </div>
          <div class="work-progress">
            <div class="work-icon-box ">
              <span><img src="images/services/air/sanitization.png"></span>
            </div>
            <h3 class="caption">Sanitization of tools &amp; area</h3>
          </div>
          <div class="work-arrow">
          </div>
          <div class="work-progress">
            <div class="work-icon-box">
              <span><img src="images/services/air/aarogya.png"></span>
            </div>
            <h3 class="caption">Arogya Setu to ensure safety</h3>
          </div>
  ...
  <section class="define">
    <div class="container">
      <div class="main_def">
        <div class="main-left">
          <div class="repair">
            <h2>AC Pipeline Underground Fitting Services in Greater Noida</h2>
          ...
          <div class="repair">
            <h3>Underground Pipe Fitting Services in Greater Noida</h3>
